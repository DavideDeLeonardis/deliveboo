    ...
    <div class="container">
        <div class="row">
            <div class="col mt-5 mb-5">
                <div class="card card-edit-user p-3">
                    <h1 class="title-edit-user" style="color: #08a88a !important">
                    ...
                    <form action="{{ route('admin.user.update', $user) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="email" class="form-label">
                                <h5 class="h5-edit-user">Email:</h5>
                            </label>
                        ...
                        <div class="mb-3">
                            <label for="address" class="form-label">
                                <h5 class="h5-edit-user">Indirizzo:</h5>
                            </label>
                            <input type="text" class="form-control" style="background-color: rgb(56, 193, 114, 0.2)"
                        ...
                        <div class="mb-3">
                            <label for="phone" class="form-label">
                                <h5 class="h5-edit-user">Telefono:</h5>
                            </label>
                            <input type="text" class="form-control" style="background-color: rgb(56, 193, 114, 0.2)"
                        ...
                        <div class="mb-3">
                            <label for="p_iva" class="form-label">
                                <h5 class="h5-edit-user">P IVA</h5>
                            </label>
                            <input type="text" class="form-control" style="background-color: rgb(56, 193, 114, 0.2)"
                        ...
                        <fieldset class="mb-3">
                            <legend>
                                <h5 class="h5-edit-user">Categorie</h5>
                            </legend>
                            @if ($errors->any())
                        ...
                        <button type="submit" class="btn btn-success text-light p-2 mt-3 btn-edit-user"
