    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-around">
                <div class="card m-3 mt-5 card-user-index">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">P IVA: {{ $user->p_iva }}</p>
                        <hr>
